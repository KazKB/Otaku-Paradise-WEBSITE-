...
<html lang="en">
    ...
    <body>
        ...
        <header style="border: 0.2em solid #58DA8A"> 
            <h1 id="title" style="background-color: #58DA8A"> Apparel</h1>
        ...
        <main>
            ...
            <div class="item">
                ...
                <p class="price" onclick="traverse('purchase.php'); sessionStorage.setItem('item', 'apparel');">$25.00</p>
            </div>
            <div class="item">
                <picture>
                    <source srcset="Images/t-shirt-sm.png" media="(min-width: 700px)"> 
        ...
        <!-- Footer of Site -->
        <footer style="background-color: #58DA8A">
