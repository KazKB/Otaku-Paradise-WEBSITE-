...
<html lang="en">
    ...
    <body>
        ...
        <header style="border: 0.2em solid #C5C500"> 
            <h1 id="title" style="background-color: #C5C500"> Accessories</h1>
        ...
        <main>
           ...
           <div class="item">
                ...
                <p class="price "onclick="traverse('purchase.php'); sessionStorage.setItem('item', 'accessories');">$45.00</p>
            </div>
            <div class="item">
                <picture>
                    <source srcset="Images/accessory-sm.png" media="(min-width: 700px)"> 
        ...
        <!-- Footer of Site -->
        <footer style="background-color: #C5C500">
