...
<html lang="en">
    ...
    <body>
        ...
        <header style="border: 0.2em solid black"> 
            <h1 id="title" style="background-color: black"> View All</h1>
        ...
        <main>
            ...
            <div class="item">
                <picture>
                    <source srcset="Images/t-shirt-sm.png" media="(min-width: 700px)"> 
                    <img src="Images/t-shirt-es.png" alt="T-Shirt">
                </picture>
                <p onclick="traverse('purchase.php'); sessionStorage.setItem('item', 'apparel');"> Naruto and Sasuke T-Shirt</p>
                <p class="price" onclick="traverse('purchase.php')">$25.00</p>
            </div>
            <div class="item">
                <picture>
            ...
            <div class="item">
                <picture>
                    <source srcset="Images/accessory-sm.png" media="(min-width: 700px)"> 
                    <img src="Images/accessory-es.png" alt="Accessory">
                </picture>
                <p onclick="traverse('purchase.php'); sessionStorage.setItem('item', 'accessories');">Sasuke Funko Pop Key Chain</p>
