...
<html lang="en">
    ...
    <body>
        ...
        <header style="border: 0.2em solid #890001"> 
            <h1 id="title" style="background-color: #890001"> Posters</h1>
        ...
        <main>
           ...
           <div class="item">
                ...
                <p class="price" onclick="traverse('purchase.php'); sessionStorage.setItem('item', 'posters');">$50.00</p>
            </div>
            <div class="item">
                <picture>
                    <source srcset="Images/poster-sm.png" media="(min-width: 700px)"> 
        ...
        <!-- Footer of Site -->
        <footer style="background-color: #890001">
