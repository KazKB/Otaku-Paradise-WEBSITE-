...
<html lang="en">
    ...
    <body>
        ...
        <header style="border: 0.2em solid #2AB1C3"> 
            <h1 id="title" style="background-color: #2AB1C3"> Figurines</h1>
        ...
        <main>
           ...
           <div class="item">
                ...
                <p class="price" onclick="traverse('purchase.php'); sessionStorage.setItem('item', 'figurines');">$75.00</p>
            </div>
            <div class="item">
                <picture>
                    <source srcset="Images/figurine-sm.png" media="(min-width: 700px)"> 
        ...
        <!-- Footer of Site -->
        <footer style="background-color: #2AB1C3">
