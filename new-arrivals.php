...
<html lang="en">
    ...
    <body>
        ...
        <header style="border: 0.2em solid #999C9E"> 
            <h1 id="title" style="background-color:#999C9E"> New Arrivals</h1>
        ...
        <main>
           ...
           <div class="item">
                <picture>
                    ...
                    <img src="Images/new-arrivals-es.png" alt="<br> Key Chains">
                </picture>
                <p onclick="traverse('purchase.php'); sessionStorage.setItem('item', 'new');">My Hero Academia <br> Key Chains</p>
                <p class="price" onclick="traverse('purchase.php'); sessionStorage.setItem('item', 'new');">$45.00</p>
            </div>
            <div class="item">
                <picture>
                    <source srcset="Images/new-arrivals-sm.png" media="(min-width: 700px)"> 
        ...
        <!-- Footer of Site -->
        <footer style="background-color: #999C9E">
